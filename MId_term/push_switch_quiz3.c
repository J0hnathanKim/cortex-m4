//1번 push switch를 누르면 dip switch 값 만큼 led 전체를 깜빡인다.
//2번 push switch를 누르면 dip switch 값 만큼 led up counting
//3번 push switch를 누르면 led 전부 on
//4번 push switch를 누르면 led 전부 off
#include "cortex_m4.h"
#include "MyLib.h"
