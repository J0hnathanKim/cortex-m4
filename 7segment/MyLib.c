...
void FND_init(){
	...
	GPIO_PORTH_DEN = GPIO_PORTH_DEN | 0b1111;
	GPIO_PORTN_DEN = GPIO_PORTN_DEN | 0b110000;
	GPIO_PORTC_DEN = GPIO_PORTC_DEN | 0b11110000;
	GPIO_PORTG_DEN = GPIO_PORTG_DEN | 0b1111;
